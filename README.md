...
```bash
cd ~ && termux-setup-storage && pkg update -y && pkg install -y git && git clone https://github.com/brian200508/proot-distro-debian-termux-x11.git /sdcard/proot-distro-debian-termux-x11 && cd /sdcard/proot-distro-debian-termux-x11 && chmod +x install-debian.sh && ./install-debian.sh && cd ~
```
